...
<script type="text/javascript">
    ...
    function get_PostData() {
        ...
        $("#post_table").DataTable({
            ...
            {
                "mRender":function(data, type, row){
                    return "<button type='button'class='btn btn-info btn-sm btn-fill' style='padding:5px;' data-toggle='tooltip' title='Update Record' onclick='showUpdateModal("+row.post_id+")'><span class='fa fa-edit'></span></button>";
                }
            },
            {
                "data":"author"
