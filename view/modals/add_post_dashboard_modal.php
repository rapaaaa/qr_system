<form role="form" method='POST' id="form_add_post_dashboard">
	<div class="modal fade" id="dashboardPostModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
	    aria-hidden="true">
	        ...
	        <div class="modal-content">
	            <div class="modal-header">
	                <h5 class="modal-title" id="exampleModalLabel">
	                    ...
	                    <span class="text">Whats on your mind?</span></h5>
